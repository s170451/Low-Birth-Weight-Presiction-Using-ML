...
def fetalbwprediction():
    if request.method == 'POST':
        ...
        if final_prediction<2.5:
            weight_class = 'Low Birth Weight'
        elif final_prediction<1.5:
            weight_class = 'Very low Birth Weight'
        elif final_prediction<1.0:
            weight_class = 'Extreme low Birth Weight'
        else :
            weight_class = 'Normal Birth Weight'
        return render_template('fetal_birthweight_result.html', prediction=final_prediction,weight_class=weight_class)
